...
const ItemPage = () => {
    ...
    //Updates the Rent form based on any changes from user inputs
    ...
    //Allows users to remove any items as a favourite
            ...
            <div className='itemPageContainer'>
                ...
                {itemDetails.itemPhotoUrl ? <img className="itemImg" src={itemDetails.itemPhotoUrl}/> : <img className='itemImg' src= "https://i.stack.imgur.com/mwFzF.png"/>}
                    <div className='itemInfoBox'> 
                        ...
                        {( userDetails.id != itemAuthor.id) && <div> {itemDetails.isAvailable && <div>
                        {loggedIn && <section className="rentFunctions"> 
                            ...
                            {loggedIn && 
                                <div>
                                    ...
                                    <button className="appBtn" type='submit' onClick={rentItem}>Rent</button> : 
                                    <button disabled className="btnReplacment">Unavailable</button>}
                                </div>}
                            </section>} </div>}
                            <p>{reqStatus}</p> </div>}
